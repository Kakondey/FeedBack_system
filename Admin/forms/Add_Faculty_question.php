<?php
    ...
    if (isset($_POST['Add'])) {
        ...
        $sql = "INSERT INTO faculty_questions(Question) VALUES ('$Question')";    

        if (mysqli_query($conn, $sql)) 
        {
            $successmsz = 'New Question Added.';
            header("refresh:1; url=Add_Faculty_question.php");
        }
        else
        {
                            ...
                            <div class="module-body">
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal row-fluid" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Question" name="Question" class="span8"><br><br>
                                            </div>
                                        </div>
