<?php
    ...
    if (isset($_POST['Update'])) {
        ...
        if (!$error) {
            ...
            $sqlu = "UPDATE faculty SET Faculty_name='$_POST[Faculty_name]',Gender='$_POST[Gender]',
                    Phone_no='$_POST[Phone_no]',Department='$_POST[Department]' 
                    WHERE F_id='$_POST[F_id]'";

            if (mysqli_query($conn, $sqlu)) 
            {
                $successmsz = 'Details Successfully Updated.';
                header('Refresh:1; ../lists/Faculty_list.php');
            }
            else
            {
    ...
    if (isset($_GET['edit'])) {
        $sqlE = "SELECT * FROM faculty WHERE F_id='{$_GET['F_id']}'";
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <center><h3>Edit Faculty Details</h3></center>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal row-fluid" >
                                            ...
                                            <input type="hidden" id="F_id" value="<?php echo $F_id; ?>" name="F_id" class="span8"><br><br>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Faculty_name" value="<?php echo $Faculty_name; ?>" name="Faculty_name" class="span8"><br><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                name="Phone_no" value="<?php echo $Phone_no; ?>" class="span8" required><br>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Department" value="<?php echo $Department; ?>" name="Department" class="span8"><br><br>
                                            </div>
                                        </div>
