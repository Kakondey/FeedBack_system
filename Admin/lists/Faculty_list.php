<?php
    ...
    if (isset($_GET['delete'])) {
        $sqlD = "DELETE FROM faculty WHERE F_id='{$_GET['F_id']}'";
        $dQuery = mysqli_query($conn,$sqlD);
        if ($dQuery) {
            header('Refresh:1; Faculty_list.php');
        }
    }
                                    ...
                                    <?php
                                        ...
                                        <tbody>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a href="../forms/Edit_FacultyDetails.php?edit=1&F_id=<?php echo $row->F_id; ?>" ><input class="btn btn-primary btn-small" value="EDIT" type="submit" name="EDIT"></a></td>
                                                <td><a href="Faculty_list.php?delete=1&F_id=<?php echo $row->F_id; ?>"><input class="btn btn-primary btn-small" value="DELETE" type="submit" name="DELETE"></a></td>
                                            </tr>
                                        </tbody>
                                        <?php
                                            }
