<?php
    ...
    if (isset($_GET['delete'])) {
        $sqlD = "DELETE FROM facility WHERE Fa_qId='{$_GET['Fa_qId']}'";
        $dQuery = mysqli_query($conn,$sqlD);
        if ($dQuery) {
            header('Refresh:1; Facility_list.php');
        }
    }
                                    ...
                                    <?php
                                        ...
                                        <tbody>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a href="../forms/Edit_FacultyQuestionDetails.php?edit=1&Fa_qId=<?php echo $row->Fa_qId; ?>" ><input class="btn btn-primary btn-small" value="EDIT" type="submit" name="EDIT"></a></td>
                                                <td><a href="faculty_question_list.php?delete=1&Fa_qId=<?php echo $row->Fa_qId; ?>"><input class="btn btn-primary btn-small" value="DELETE" type="submit" name="DELETE"></a></td>
                                            </tr>
                                        </tbody>
                                        <?php
                                            }
