<?php
    ...
    if (isset($_GET['delete'])) {
        $sqlD = "DELETE FROM facility WHERE fa_id='{$_GET['fa_id']}'";
                                    ...
                                    <?php
                                        ...
                                        <tbody>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a href="../forms/Edit_FacilityDetails.php?edit=1&fa_id=<?php echo $row->fa_id; ?>" ><input class="btn btn-primary btn-small" value="EDIT" type="submit" name="EDIT"></a></td>
                                                <td><a href="Facility_list.php?delete=1&fa_id=<?php echo $row->fa_id; ?>"><input class="btn btn-primary btn-small" value="DELETE" type="submit" name="DELETE"></a></td>
                                            </tr>
                                        </tbody>
                                        <?php
                                            }
