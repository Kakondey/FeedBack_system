			...
			<div class="container">
				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<ul class="nav pull-right">
						...
						<li><a class="User" href="forms/Student_Signup.php">
							Signup
						</a></li>
					</ul>
				</div><!-- /.nav-collapse -->
						...
						<div class="module-body">
										<?php
                                            if(isset($errormsg))
                                            {
                                              ...
                                              <div class="alert alert-error">
                                                ...
                                                <a href="Student_Signin.php"><?php echo $errormsg; ?><a/> 
                                              </div>
                                              <?php
                                            }
                                        ?>
							<div class="control-group">
								<div class="controls row-fluid">
									<input class="span12" name="Student_name" type="text"  placeholder="name">
								</div>
							</div>
							<div class="control-group">
								<div class="controls row-fluid">
